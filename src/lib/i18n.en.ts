/**
 * قاموس الترجمة الإنجليزية. المفتاح هو النص العربي كما هو مكتوب في الواجهة،
 * فأي نص غير مترجم يظهر بالعربية تلقائيًا بدل أن ينكسر.
 */
export const en: Record<string, string> = {
  ...
  "ابقَ على اطلاع بآخر الأخبار المالية وأخبار سوق الذهب، مع تحليلات وتحديثات تساعدك على اتخاذ قرارات أذكى.":
    "Stay up to date with the latest financial and gold-market news, with analysis and updates that help you make smarter decisions.",
  السابق: "Previous",
  التالي: "Next",
  "مشاهدة الكل": "View all",

  // الأسعار اللحظية والسوق
  ثابت: "Unchanged",
  "سجل آخر 60 ثانية": "Last 60 seconds",
  تحديث: "updates",
  "جاري تجميع التحديثات اللحظية…": "Collecting live updates…",
  "جرام عيار 24": "24K per gram",
  ثانية: "sec",
  دقيقة: "min",
  ساعة: "hr",
  يوم: "day",
  ...
  "ج.م": "EGP",
  جنيه: "EGP",
  "سعر الشراء هو ما تدفعه عند الشراء، وسعر البيع هو ما ندفعه لك عند إعادة الشراء منك.":
    "The buy price is what you pay; the sell price is what we pay you when we buy back from you.",
  "الفرق بينهما": "The gap between them is",
  "ويمثل هامش التشغيل، وهو ثابت ومعلن.":
    "which is our operating margin — fixed and publicly stated.",
  العيار: "Karat",
  الفرق: "Spread",
  جرام: "g",
  جم: "g",
  كيلو: "kg",
  "ذهب عيار 24": "Gold 24K",
  "ذهب عيار 22": "Gold 22K",
  "ذهب عيار 21": "Gold 21K",
  "ذهب عيار 18": "Gold 18K",
  الفضة: "Silver",
  الدولار: "US dollar",
  "سبيكة 10 جرام": "10g bar",
  "جنيه ذهب 8 جرام": "8g gold sovereign",
  "جارٍ تحميل الأسعار": "Loading prices",
  "بث مباشر": "Live",
  "الاتصال متعذر": "Connection lost",
  متصل: "Online",
  "غير متصل": "Offline",
  "انقطع الاتصال بالبث اللحظي": "The live price feed disconnected",
  "الأسعار المعروضة هي آخر أسعار معروفة — آخر تحديث":
    "Prices shown are the last known values — updated",
  "جارٍ إعادة المحاولة...": "Retrying...",
  "بث مباشر متصل · تحديث فوري": "Live feed connected · instant updates",
  "جاري الاتصال بالبث المباشر…": "Connecting to the live feed…",
  "أسعار مباشرة": "Live prices",
  "أسعار لحظية · آخر تحديث": "Live prices · last updated",
  "جنيه / جرام": "EGP / gram",
  ...
  "سعر الفضة": "Silver price",
  "حاسبة الميزانية": "Budget calculator",
  ...
  "سياسة الشحن والتوصيل": "Shipping & delivery policy",
  "سياسة الاسترجاع واسترداد الأموال": "Returns & refunds policy",
  ...
  "احسب زكاة ذهبك بدقة في ثوانٍ.": "Work out the zakat on your gold in seconds.",
  "إعادة البيع": "Buy-back",
  "نشتري منك ذهبك بأفضل سعر في السوق.": "We buy your gold back at the best price in the market.",
  "شهادة أصل": "Certificate of authenticity",
  ...
  "ابدأ الاستثمار": "Start investing",
  ...
  "تنبيهات تغير السعر": "Price change alerts",
  ...
  "رجوع لحسابي الحقيقي": "Back to my real account",
  "أنت الآن في وضع الديمو": "You are now in demo mode",
  "رجعت لحسابك الحقيقي": "Back on your real account",
  "تعذر التبديل": "Could not switch",
  "وضع الديمو — فلوس تجريبية": "Demo mode — play money",
  "اشحن رصيد تجريبي": "Add demo balance",
  "تمت إضافة رصيد تجريبي": "Demo balance added",
  "تعذر الشحن": "Could not top up",
  ...
  "تأكيد الحساب (OTP)": "Account confirmation (OTP)",
  "خبرة الاستثمار": "Investing experience",
  "مبتدئ — أول مرة أستثمر في الذهب": "Beginner — my first time investing in gold",
  "متوسط — عندي خبرة سنة إلى ثلاث سنوات": "Intermediate — one to three years of experience",
  "متقدم — أتعامل في الذهب والسبائك بانتظام": "Advanced — I trade gold and bullion regularly",
  الخطوة: "Step",
  "مرحبًا بعودتك": "Welcome back",
  "تعذر تسجيل الدخول": "Couldn't sign you in",
  "كلمة المرور يجب ألا تقل عن 6 أحرف": "Your password must be at least 6 characters",
  "رقم موبايل غير صحيح": "Invalid mobile number",
  "الرقم القومي 14 رقمًا": "A national ID number is 14 digits",
  ...
  "الكود 6 أرقام": "The code is 6 digits",
  ...
  رجوع: "Back",
  "تخطي هذه الخطوة (وضع التجربة)": "Skip this step (demo mode)",
  ...
  دخول: "Sign in",
  "أنشئ حسابك الآن": "Create your account now",
  "وابدأ أول عملية شراء أو استثمار في الذهب.": "and make your first gold purchase or investment.",
  "أحمد الباز": "Ahmed Elbaz",
  "لتأكيد هويتك، صوّر أو ارفع أحد المستندات التالية:":
    "To verify your identity, photograph or upload one of these documents:",
  "بطاقة الرقم القومي": "National ID card",
  "جواز السفر": "Passport",
  "رقم البطاقة / جواز السفر": "ID or passport number",
  "اكتب رقم البطاقة أو جواز السفر": "Enter your ID or passport number",
  "التعليمات تتطلب رفع صورة المستند. بياناتك تبقى آمنة وخاصة.":
    "Regulations require a photo of the document. Your data stays private and secure.",
  "الوجه الأمامي للبطاقة": "Front of the ID card",
  "صفحة بيانات الجواز": "Passport data page",
  "الوجه الخلفي للبطاقة": "Back of the ID card",
  "اكتب كود التأكيد المرسل إلى": "Enter the confirmation code sent to",
  "(أي 6 أرقام أثناء التجربة).": "(any 6 digits in demo mode).",
  "كود التأكيد": "Confirmation code",
  تأكيد: "Confirm",
  "اختر ما يصف خبرتك، عشان نرشّح لك المنتجات المناسبة.":
    "Pick what describes your experience so we can suggest the right products.",
  ...
  "14 شارع فيكتور عمانويل، سموحة، الإسكندرية": "14 Victor Emmanuel St, Smouha, Alexandria",
  "22 شارع عباس العقاد، مدينة نصر، القاهرة": "22 Abbas El-Akkad St, Nasr City, Cairo",
  "8 شارع جامعة الدول العربية، المهندسين، الجيزة":
    "8 Gameat El-Dowal El-Arabeya St, Mohandessin, Giza",
  "5 شارع الجمهورية، المنصورة، الدقهلية": "5 El-Gomhoreya St, Mansoura, Dakahlia",
  "يوميًا 10 ص – 10 م": "Daily 10am – 10pm",
  "يوميًا 10 ص – 11 م": "Daily 10am – 11pm",
  "يوميًا 11 ص – 10 م": "Daily 11am – 10pm",
  ...
  "أدخل ميزانيتك واختر المعدن والعيار، وسنستخدم السعر المباشر المطابق لنعرض لك أفضل ما يمكنك شراؤه ضمن ميزانيتك.":
    "Enter your budget and pick the metal and karat — we'll use the matching live price to show the best you can buy within it.",
  "اختر المعدن": "Choose a metal",
  الذهب: "Gold",
  "اختر العيار": "Choose a karat",
  "ميزانيتك (ج.م)": "Your budget (EGP)",
  "احسب أفضل الخيارات": "Find the best options",
  "كيف تعمل الحاسبة؟": "How does the calculator work?",
  "1. أدخل ميزانيتك": "1. Enter your budget",
  "— حدد المبلغ الذي ترغب في إنفاقه.": "— set the amount you want to spend.",
  "2. نتحقق من الأسعار المباشرة": "2. We check live prices",
  "— نحسب ميزانيتك وفق أحدث سعر متاح للمعدن والعيار الذي اخترته.":
    "— we work out your budget using the latest price for the metal and karat you chose.",
  "3. احصل على أفضل الخيارات": "3. Get the best options",
  "— نرتّب المنتجات بالأكثر وزنًا للمعدن مقابل ميزانيتك، ثم بالأقل مصنعية.":
    "— we rank products by the most metal weight for your budget, then by the lowest fabrication fee.",
  "أدخل ميزانيتك لنبدأ": "Enter your budget to get started",
  "سنعرض لك كم جرامًا تشتري وأفضل المنتجات المتاحة في حدود المبلغ.":
    "We'll show you how many grams you can buy and the best products within that amount.",
  "سعر الجرام": "Price per gram",
  "ميزانيتك تعادل": "Your budget equals",
  "قيمة المعدن بدون مصنعية": "Metal value, excluding fabrication",
  "أفضل خيار فعلي": "Best actual option",
  "لا يوجد منتج مناسب": "No matching product",
  "لا يوجد منتج ضمن هذه الميزانية": "No product fits this budget",
  "أصغر منتج متاح في هذا التصنيف يتجاوز المبلغ المدخل. جرّب مبلغًا أكبر أو عيارًا آخر.":
    "The smallest product in this category costs more than the amount entered. Try a larger amount or a different karat.",
  المنتج: "Product",
  ...
  "ابدأ من مجموعتنا واختر السبيكة أو العملة المناسبة لك.":
    "Start from our collection and pick the bar or coin that suits you.",
  "تصفح المجموعة": "Browse the collection",
  حذف: "Remove",
  "إنقاص الكمية": "Decrease quantity",
  "زيادة الكمية": "Increase quantity",
  "تقليل الكمية": "Decrease quantity",
  "إفراغ السلة": "Empty the cart",
  "ملخص الطلب": "Order summary",
  "إجمالي المنتجات": "Items subtotal",
  "الشحن المؤمّن": "Insured shipping",
  مجاني: "Free",
  ...
  "نقدًا في الفرع": "Cash at a branch",
  "أدخل عنوان التوصيل": "Enter a delivery address",
  ...
  "طلبك في حالة (قيد التنفيذ). حوّل المبلغ بالطريقة التي اخترتها وسيؤكده فريقنا خلال ساعات العمل.":
    "Your order is Processing. Transfer the amount using the method you chose and our team will confirm it during business hours.",
  "تابع طلباتك": "Track your orders",
  "بيانات الدفع": "Payment details",
  "أدخل بياناتك واختر طريقة الاستلام والدفع. يُثبَّت السعر النهائي لحظة تأكيد الطلب.":
    "Enter your details and choose how you'd like to receive and pay. The final price is locked the moment you confirm.",
  ...
  شكوى: "Complaint",
  أخرى: "Other",
  "الاسم ورقم موبايل مصري صحيح ورسالة لا تقل عن 10 أحرف.":
    "A name, a valid Egyptian mobile number, and a message of at least 10 characters.",
  "فريق خدمة العملاء متاح يوميًا خلال ساعات العمل. متوسط زمن الرد أقل من ساعتين.":
    "Our customer service team is available daily during business hours. Average reply time is under two hours.",
  "وصلتنا رسالتك": "We got your message",
  "سيتواصل معك فريقنا على الرقم": "Our team will call you on",
  ...
  اختياري: "optional",
  رسالتك: "Your message",
  "اكتب تفاصيل استفسارك…": "Write the details of your enquiry…",
  إرسال: "Send",
  "قنوات التواصل": "Contact channels",
  "الرقم الموحد": "Hotline",
  "ساعات العمل": "Business hours",
  "يوميًا من 10 صباحًا حتى 10 مساءً": "Daily from 10am to 10pm",
  ...
  "من صفحة تسجيل الدخول اختر (حساب جديد)، وأدخل اسمك وبريدك الإلكتروني وكلمة مرور. تستغرق العملية أقل من دقيقة.":
    "On the sign-in page choose New account and enter your name, email and a password. It takes under a minute.",
  "هل يجب التحقق من هويتي؟": "Do I have to verify my identity?",
  "التصفح والشراء بالقيم الصغيرة لا يحتاج تحققًا. عند تجاوز حدود معينة نطلب صورة بطاقة الرقم القومي التزامًا بقواعد (اعرف عميلك).":
    "Browsing and small purchases need no verification. Above certain limits we ask for a photo of your national ID to comply with Know Your Customer rules.",
  "نسيت كلمة المرور، ماذا أفعل؟": "I forgot my password — what do I do?",
  "من صفحة الدخول اضغط (نسيت كلمة المرور) وأدخل بريدك، وسيصلك رابط إعادة تعيين صالح لمدة ساعة.":
    "On the sign-in page tap Forgot password and enter your email; you'll get a reset link valid for one hour.",
  "هل يمكنني تغيير رقم الهاتف؟": "Can I change my phone number?",
  ...
  "لماذا يختلف سعر الشراء عن سعر البيع؟": "Why is the buy price different from the sell price?",
  "الفرق بينهما هو هامش التاجر، ويغطي تكلفة التشغيل والتغليف والضمان. الهامش لدينا معلن وثابت النسبة، وتجده موضحًا على صفحة أسعار الذهب.":
    "The gap is the dealer margin, covering operating, packaging and warranty costs. Our margin is published at a fixed percentage and shown on the gold price page.",
  "ما هي العيارات المتاحة؟": "Which karats are available?",
  ...
  الشراء: "Buying",
  "كيف أشتري الذهب؟": "How do I buy gold?",
  "اختر المنتج من مجموعتنا، أضفه للسلة، ثم أكمل بياناتك في صفحة إتمام الطلب. أو اشترِ بالجرام مباشرة من محفظتك دون استلام مادي.":
    "Pick a product from our collection, add it to the cart, then fill in your details at checkout. Or buy by the gram straight from your wallet with no physical delivery.",
  "ما هو الحد الأدنى للشراء؟": "Is there a minimum purchase?",
  "لا يوجد حد أدنى للشراء من المحفظة — يمكنك شراء جزء من الجرام. أصغر منتج مادي لدينا سبيكة 0.25 جرام.":
    "There's no minimum when buying from the wallet — you can buy a fraction of a gram. Our smallest physical product is a 0.25g bar.",
  "على أي سعر يتم تنفيذ الشراء؟": "Which price is the purchase executed at?",
  "على سعر الشراء المعروض لحظة تأكيد الطلب. أي سعر تراه قبل التأكيد استرشادي وقابل للتغير مع حركة السوق.":
    "The buy price shown at the moment you confirm the order. Any price before that is indicative and can move with the market.",
  "هل توجد رسوم على الشراء؟": "Are there fees on purchases?",
  "لا توجد رسوم خدمة. السعر النهائي يشمل قيمة المعدن والمصنعية فقط، وتُضاف رسوم التوصيل عند اختيار الشحن للمنزل.":
    "No service fees. The final price covers only the metal value and fabrication; delivery fees are added if you choose home delivery.",
  "هل يمكنني إلغاء عملية شراء؟": "Can I cancel a purchase?",
  ...
  "على سعر البيع المعروض لحظة تنفيذ العملية، وهو أقل من سعر الشراء بمقدار هامش التاجر المعلن.":
    "The sell price shown at the moment the transaction goes through, which is below the buy price by our published dealer margin.",
  "ما هو برنامج الكاش باك؟": "What is the cashback programme?",
  "عند إعادة بيع سبيكة اشتريتها منا، نرد لك جزءًا من المصنعية يصل إلى 50%، بشرط أن تكون العبوة الأصلية سليمة وغير مفتوحة.":
    "When you sell back a bar you bought from us, we refund up to 50% of the fabrication fee, provided the original packaging is intact and unopened.",
  "المحفظة والإيداع": "Wallet and deposits",
  "كيف أضيف أموالًا لحسابي؟": "How do I add money to my account?",
  "من صفحة المحفظة اختر (شحن رصيد) وأدخل المبلغ، ثم حوّل عبر InstaPay أو تحويل بنكي إلى الحساب الموضح في صفحة طرق الدفع.":
    "On the wallet page choose Top up, enter the amount, then transfer via InstaPay or bank transfer to the account shown on the payment methods page.",
  "أين أرى رصيدي وكمية الذهب التي أملكها؟": "Where do I see my balance and how much gold I own?",
  "في صفحة المحفظة: بطاقة للرصيد النقدي، وبطاقة لرصيد الذهب بالجرام وقيمته الحالية بسعر البيع، وبطاقة لإجمالي المحفظة.":
    "On the wallet page: a card for your cash balance, one for your gold balance in grams and its current value at the sell price, and one for the wallet total.",
  "أين أرى معاملاتي السابقة؟": "Where do I see my past transactions?",
  "في أسفل صفحة المحفظة يوجد سجل بآخر 20 حركة، موضحًا نوعها وتاريخها والمبلغ والجرامات.":
    "At the bottom of the wallet page there's a log of your last 20 movements showing type, date, amount and grams.",
  "لماذا لم يتحدث رصيدي؟": "Why hasn't my balance updated?",
  "عمليات المحفظة فورية. إذا كنت قد حوّلت أموالًا من خارج المنصة، فالإضافة تحتاج مطابقة يدوية قد تستغرق حتى ساعتين في ساعات العمل.":
    "Wallet operations are instant. If you transferred money from outside the platform, crediting needs a manual match that can take up to two hours during business hours.",
  "الطلبات والشحن": "Orders and shipping",
  "كيف أتابع حالة طلبي؟": "How do I track my order?",
  "من صفحة طلباتي، تجد كل طلباتك وحالتها الحالية ورقم الطلب.":
    "On the My orders page you'll find all your orders with their current status and order number.",
  "ماذا تعني حالة (قيد التنفيذ)؟": "What does Processing mean?",
  "أن الطلب وصلنا وجارٍ تأكيد السداد ومطابقة البيانات قبل التجهيز.":
    "We've received the order and are confirming payment and checking details before preparing it.",
  "ماذا تعني حالة (مكتمل)؟": "What does Completed mean?",
  "أن الطلب تم تسليمه أو استلامه من الفرع وانتهت العملية.":
    "The order was delivered or collected at a branch and the transaction is closed.",
  "ماذا تعني حالة (ملغي)؟": "What does Cancelled mean?",
  "أن الطلب أُلغي بطلب منك أو من جانبنا. إن كان مدفوعًا يُرد المبلغ بالكامل.":
    "The order was cancelled by you or by us. If it was paid, the amount is refunded in full.",
  ...
  "من يوم إلى يومي عمل في القاهرة والجيزة والإسكندرية، ومن يومين إلى 4 أيام لباقي المحافظات.":
    "One to two business days in Cairo, Giza and Alexandria, and two to four days for other governorates.",
  "هل الشحن مؤمّن؟": "Is shipping insured?",
  ...
  "غيّر كلمة المرور فورًا وتواصل معنا على 17608 مع رقم المعاملة وتاريخها.":
    "Change your password immediately and call us on 17608 with the transaction number and date.",
  "ماذا أفعل إذا فقدت هاتفي؟": "What if I lose my phone?",
  "سجّل الدخول من أي جهاز آخر وغيّر كلمة المرور، وسيتم إنهاء الجلسات الأخرى.":
    "Sign in from any other device and change your password — all other sessions will be ended.",
  "كيف أحافظ على أمان حسابي؟": "How do I keep my account secure?",
  ...
  "لا توجد نتائج لبحثك. جرّب كلمة أخرى أو تواصل معنا مباشرة.":
    "No results for your search. Try another word or contact us directly.",
  "لم تجد إجابة سؤالك؟": "Didn't find your answer?",
  ...
  "لا يمكن إلغاء الطلب بعد شحنه": "An order can't be cancelled once it has shipped",
  "تعذر إلغاء الطلب": "Couldn't cancel the order",
  "تم إلغاء الطلب": "Order cancelled",
  "كل طلباتك وحالتها الحالية. يمكنك إلغاء أي طلب ما دام لم يُشحن بعد.":
    "All your orders and their current status. You can cancel any order that hasn't shipped yet.",
  "لا توجد طلبات بعد": "No orders yet",
  "استلام من": "Pickup from",
  ...
  "حوّل من تطبيق بنكك مباشرة إلى عنوان الدفع الخاص بنا. أسرع وسيلة لتأكيد الطلب.":
    "Transfer straight from your banking app to our payment address. The fastest way to get an order confirmed.",
  ...
  الصفحة: "Page",
  "ادفع واستلم في نفس اللحظة من أي فرع من فروعنا خلال ساعات العمل.":
    "Pay and collect on the spot at any of our branches during business hours.",
  الفروع: "Branches",
  "تم النسخ": "Copied",
  "تعذر النسخ، انسخه يدويًا": "Couldn't copy — please copy it manually",
  "اختر الطريقة المناسبة لك وأكمل معاملتك بأمان. لا نفرض أي رسوم خدمة على أي وسيلة دفع.":
    "Pick the method that suits you and complete your transaction securely. We charge no service fees on any payment method.",
  ...
  "إعادة شراء": "Buy-back",
  "في أي فرع من فروعنا": "At any of our branches",
  "شحن مؤمّن": "Insured shipping",
  "لكل محافظات مصر": "To every governorate in Egypt",
  "العلامة التجارية": "Brand",
  المعدن: "Metal",
  الوزن: "Weight",
  المصنعية: "Fabrication fee",
  التوفر: "Availability",
  متوفر: "In stock",
  ...
  "المصنعية المستردّة": "Refundable fabrication",
  حتى: "up to",
  "نشتري منك هذا المنتج في أي وقت بسعر البيع اللحظي، ونرد لك جزءًا من المصنعية بشرط بقاء العبوة الأصلية سليمة وغير مفتوحة.":
    "We buy this product back any time at the live sell price and refund part of the fabrication fee, provided the original packaging is intact and unopened.",
  ...
  "سحب رصيد": "Withdraw",
  "شراء ذهب": "Buy gold",
  "اشترِ الذهب": "Buy gold",
  "بيع ذهب": "Sell gold",
  "رصيدك النقدي لا يكفي": "Your cash balance isn't enough",
  "رصيد الذهب لا يكفي": "Your gold balance isn't enough",
  "الحد الأدنى للشحن 100 جنيه": "The minimum top-up is EGP 100",
  "السحب والبيع متوقفان حاليًا": "Withdrawals and selling are currently paused",
  "سعر الجرام غير متاح الآن": "The gram price isn't available right now",
  "حاول بعد لحظات.": "Try again in a moment.",
  "تعذر تنفيذ العملية": "Couldn't complete the transaction",
  "تمت العملية بنجاح": "Transaction completed",
  "اشحن رصيدك واشترِ الذهب بالجرام بسعر السوق اللحظي، ويُحفظ باسمك في خزائن مؤمّنة.":
    "Top up your balance and buy gold by the gram at the live market price, held in your name in secure vaults.",
  ...
  "سبيكة ذهب 2.5 جرام": "2.5g Gold Bar",
  "سبيكة ذهب خالص عيار 24 بوزن 2.5 جرام من سام، مختومة من مصلحة الدمغة والموازين ومغلّفة في عبوة مؤمّنة ضد العبث. السعر مرتبط بسعر الذهب اللحظي في السوق المصري، ويمكنك استرداد حتى 50% من المصنعية عند إعادة البيع بشرط بقاء العبوة الأصلية.":
    "A 2.5g pure 24K gold bar from Sam, hallmarked by the Egyptian Assay and Weights Authority and sealed in tamper-evident packaging. The price tracks the live gold price in the Egyptian market, and you can recover up to 50% of the fabrication fee on buy-back as long as the original packaging is intact.",
  "سبيكة ذهب 5 جرام": "5g Gold Bar",
  "سبيكة ذهب خالص عيار 24 بوزن 5 جرام من سام، مختومة من مصلحة الدمغة والموازين ومغلّفة في عبوة مؤمّنة ضد العبث. السعر مرتبط بسعر الذهب اللحظي في السوق المصري، ويمكنك استرداد حتى 50% من المصنعية عند إعادة البيع بشرط بقاء العبوة الأصلية.":
    "A 5g pure 24K gold bar from Sam, hallmarked by the Egyptian Assay and Weights Authority and sealed in tamper-evident packaging. The price tracks the live gold price in the Egyptian market, and you can recover up to 50% of the fabrication fee on buy-back as long as the original packaging is intact.",
  "سبيكة ذهب 10 جرام": "10g Gold Bar",
  "سبيكة ذهب خالص عيار 24 بوزن 10 جرام من سام، مختومة من مصلحة الدمغة والموازين ومغلّفة في عبوة مؤمّنة ضد العبث. السعر مرتبط بسعر الذهب اللحظي في السوق المصري، ويمكنك استرداد حتى 50% من المصنعية عند إعادة البيع بشرط بقاء العبوة الأصلية.":
    "A 10g pure 24K gold bar from Sam, hallmarked by the Egyptian Assay and Weights Authority and sealed in tamper-evident packaging. The price tracks the live gold price in the Egyptian market, and you can recover up to 50% of the fabrication fee on buy-back as long as the original packaging is intact.",
  "سبيكة ذهب 20 جرام": "20g Gold Bar",
  "سبيكة ذهب خالص عيار 24 بوزن 20 جرام من سام، مختومة من مصلحة الدمغة والموازين ومغلّفة في عبوة مؤمّنة ضد العبث. السعر مرتبط بسعر الذهب اللحظي في السوق المصري، ويمكنك استرداد حتى 50% من المصنعية عند إعادة البيع بشرط بقاء العبوة الأصلية.":
    "A 20g pure 24K gold bar from Sam, hallmarked by the Egyptian Assay and Weights Authority and sealed in tamper-evident packaging. The price tracks the live gold price in the Egyptian market, and you can recover up to 50% of the fabrication fee on buy-back as long as the original packaging is intact.",
  "سبيكة ذهب 31.1 جرام": "31.1g Gold Bar",
  "سبيكة ذهب خالص عيار 24 بوزن 31.1 جرام من بي تي سي، مختومة من مصلحة الدمغة والموازين ومغلّفة في عبوة مؤمّنة ضد العبث. السعر مرتبط بسعر الذهب اللحظي في السوق المصري، ويمكنك استرداد حتى 50% من المصنعية عند إعادة البيع بشرط بقاء العبوة الأصلية.":
    "A 31.1g pure 24K gold bar from BTC, hallmarked by the Egyptian Assay and Weights Authority and sealed in tamper-evident packaging. The price tracks the live gold price in the Egyptian market, and you can recover up to 50% of the fabrication fee on buy-back as long as the original packaging is intact.",
  "سبيكة ذهب 50 جرام": "50g Gold Bar",
  "سبيكة ذهب خالص عيار 24 بوزن 50 جرام من بي تي سي، مختومة من مصلحة الدمغة والموازين ومغلّفة في عبوة مؤمّنة ضد العبث. السعر مرتبط بسعر الذهب اللحظي في السوق المصري، ويمكنك استرداد حتى 50% من المصنعية عند إعادة البيع بشرط بقاء العبوة الأصلية.":
    "A 50g pure 24K gold bar from BTC, hallmarked by the Egyptian Assay and Weights Authority and sealed in tamper-evident packaging. The price tracks the live gold price in the Egyptian market, and you can recover up to 50% of the fabrication fee on buy-back as long as the original packaging is intact.",
  "سبيكة ذهب 100 جرام": "100g Gold Bar",
  "سبيكة ذهب خالص عيار 24 بوزن 100 جرام من جولد إيرا، مختومة من مصلحة الدمغة والموازين ومغلّفة في عبوة مؤمّنة ضد العبث. السعر مرتبط بسعر الذهب اللحظي في السوق المصري، ويمكنك استرداد حتى 50% من المصنعية عند إعادة البيع بشرط بقاء العبوة الأصلية.":
    "A 100g pure 24K gold bar from Gold Era, hallmarked by the Egyptian Assay and Weights Authority and sealed in tamper-evident packaging. The price tracks the live gold price in the Egyptian market, and you can recover up to 50% of the fabrication fee on buy-back as long as the original packaging is intact.",
  "جنيه ذهب إنجليزي": "British Gold Sovereign",
  "جنيه ذهب إنجليزي عيار 22 بوزن 8 جرام، من أكثر العملات الذهبية تداولًا في السوق المصري وأسرعها في إعادة البيع. مرفق معها شهادة أصل وعبوة محكمة الغلق.":
    "A British Gold Sovereign, 22K, weighing 8g — one of the most actively traded gold coins in the Egyptian market and among the quickest to resell. Supplied with a certificate of authenticity in sealed packaging.",
  ...
  "غويشة ذهب مصرية": "Egyptian Gold Bangle",
  "غويشة ذهب مصرية عيار 21 بوزن 12 جرام، مدموغ بمصلحة الدمغة والموازين ومرفق معه فاتورة ضريبية معتمدة وشهادة ضمان.":
    "A Egyptian Gold Bangle, 21K, weighing 12g — hallmarked by the Egyptian Assay and Weights Authority and supplied with an approved tax invoice and a warranty certificate.",
  "سلسلة ذهب عيار 18": "18K Gold Chain",
  "سلسلة ذهب عيار 18 عيار 18 بوزن 6 جرام، مدموغ بمصلحة الدمغة والموازين ومرفق معه فاتورة ضريبية معتمدة وشهادة ضمان.":
    "A 18K Gold Chain, 18K, weighing 6g — hallmarked by the Egyptian Assay and Weights Authority and supplied with an approved tax invoice and a warranty certificate.",
  "سبيكة فضة 5 جرام": "5g Silver Bar",
  "سبيكة فضة نقية 999 بوزن 5 جرام من بي تي سي، مغلّفة في عبوة مؤمّنة. بديل اقتصادي لبدء الادخار في المعادن النفيسة وتنويع المحفظة.":
    "A 5g pure 999 silver bar from BTC, in sealed protective packaging. An affordable way to start saving in precious metals and diversify your portfolio.",
  "سبيكة فضة 8 جرام": "8g Silver Bar",
  "سبيكة فضة نقية 999 بوزن 8 جرام من بي تي سي، مغلّفة في عبوة مؤمّنة. بديل اقتصادي لبدء الادخار في المعادن النفيسة وتنويع المحفظة.":
    "A 8g pure 999 silver bar from BTC, in sealed protective packaging. An affordable way to start saving in precious metals and diversify your portfolio.",
  "سبيكة فضة 10 جرام": "10g Silver Bar",
  "سبيكة فضة نقية 999 بوزن 10 جرام من بي تي سي، مغلّفة في عبوة مؤمّنة. بديل اقتصادي لبدء الادخار في المعادن النفيسة وتنويع المحفظة.":
    "A 10g pure 999 silver bar from BTC, in sealed protective packaging. An affordable way to start saving in precious metals and diversify your portfolio.",
  "سبيكة فضة 50 جرام": "50g Silver Bar",
  "سبيكة فضة نقية 999 بوزن 50 جرام من بي تي سي، مغلّفة في عبوة مؤمّنة. بديل اقتصادي لبدء الادخار في المعادن النفيسة وتنويع المحفظة.":
    "A 50g pure 999 silver bar from BTC, in sealed protective packaging. An affordable way to start saving in precious metals and diversify your portfolio.",
  "سبيكة فضة 100 جرام": "100g Silver Bar",
  "سبيكة فضة نقية 999 بوزن 100 جرام من بي تي سي، مغلّفة في عبوة مؤمّنة. بديل اقتصادي لبدء الادخار في المعادن النفيسة وتنويع المحفظة.":
    "A 100g pure 999 silver bar from BTC, in sealed protective packaging. An affordable way to start saving in precious metals and diversify your portfolio.",
  "سبيكة فضة 250 جرام": "250g Silver Bar",
  "سبيكة فضة نقية 999 بوزن 250 جرام من جولد إيرا، مغلّفة في عبوة مؤمّنة. بديل اقتصادي لبدء الادخار في المعادن النفيسة وتنويع المحفظة.":
    "A 250g pure 999 silver bar from Gold Era, in sealed protective packaging. An affordable way to start saving in precious metals and diversify your portfolio.",
  "سبيكة فضة 500 جرام": "500g Silver Bar",
  "سبيكة فضة نقية 999 بوزن 500 جرام من جولد إيرا، مغلّفة في عبوة مؤمّنة. بديل اقتصادي لبدء الادخار في المعادن النفيسة وتنويع المحفظة.":
    "A 500g pure 999 silver bar from Gold Era, in sealed protective packaging. An affordable way to start saving in precious metals and diversify your portfolio.",
  "سبيكة فضة 1 كيلو": "1kg Silver Bar",
  "سبيكة فضة نقية 999 بوزن 1 كيلو من جولد إيرا، مغلّفة في عبوة مؤمّنة. بديل اقتصادي لبدء الادخار في المعادن النفيسة وتنويع المحفظة.":
    "A 1kg pure 999 silver bar from Gold Era, in sealed protective packaging. An affordable way to start saving in precious metals and diversify your portfolio.",
  "عيار 24 – 999.9": "24K – 999.9",
  "عيار 22 – 8 جرام": "22K – 8g",
  "عيار 22 – 4 جرام": "22K – 4g",
  "عيار 24 – 8 جرام": "24K – 8g",
  "عيار 24 – 4 جرام": "24K – 4g",
  "عيار 21 – 12 جرام": "21K – 12g",
  "عيار 18 – 6 جرام": "18K – 6g",
  // التقارير
  شهري: "Monthly",
  أسبوعي: "Weekly",
  "ربع سنوي": "Quarterly",
