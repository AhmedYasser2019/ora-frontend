...
export const en: Record<string, string> = {
  ...
  "تم تسجيل خروج أجهزتك الأخرى.": "Your other devices were signed out.",
  "تعذر تغيير كلمة المرور": "Could not change your password",
  "سجّل الدخول بكلمة المرور الجديدة.": "Sign in with your new password.",
